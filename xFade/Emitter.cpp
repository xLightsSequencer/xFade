...
public:
    ...
    virtual void* Entry() override
    {
        ...
        {
            spdlog::error("Error creating E131 datagram => {} : {}, from {}.", e131SocketSend->LastError(), DecodeIPError(e131SocketSend->LastError()), localaddr.IPAddress().ToStdString());
            delete e131SocketSend;
            e131SocketSend = nullptr;
        }
        ...
        {
            spdlog::error("Error creating artNET datagram => {} : {}, from {}.", artNETSocketSend->LastError(), DecodeIPError(artNETSocketSend->LastError()), localaddr.IPAddress().ToStdString());
            delete artNETSocketSend;
            artNETSocketSend = nullptr;
        }
